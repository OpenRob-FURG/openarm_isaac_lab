...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        #TODO: check if the entire arm position is relevant
        joint_pos = ObsTerm(
            func=mdp.joint_pos_rel,
            params={
                "asset_cfg": SceneEntityCfg(
                    "robot", joint_names=["openarm_left_joint.*", "openarm_left_finger_joint.*", "openarm_right_joint.*", "openarm_right_finger_joint.*"]
                )
            },
        )
        # joint_vel = ObsTerm(
